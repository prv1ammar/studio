...
NODE_MAP = {
    ...
    "slack_node": "app.nodes.communication.slack_node.SlackNode",
    "slack_send_message": "app.nodes.communication.slack_node.SlackNode",
    "slack_action": "app.nodes.communication.slack_node.SlackNode",
    "discord_node": "app.nodes.communication.discord_node.DiscordNode",
    "discord_message_send": "app.nodes.communication.discord_node.DiscordNode",
    "telegram_node": "app.nodes.communication.telegram_node.TelegramNode",
    "gmail_node": "app.nodes.productivity.gmail_node.GmailNode",
    "gmail_send": "app.nodes.productivity.gmail_node.GmailNode",
    "gmail_send_message": "app.nodes.productivity.gmail_node.GmailNode",
    
    # Batch 105: Productivity Suite (n8n/Zapier Parity)
    "github_node": "app.nodes.productivity.github_node.GitHubNode",
    "github_action": "app.nodes.productivity.github_node.GitHubNode",
    "notion_node": "app.nodes.productivity.notion_node.NotionNode",
    "notion_action": "app.nodes.productivity.notion_node.NotionNode",
    "jira_node": "app.nodes.productivity.jira_node.JiraNode",
    "jira_action": "app.nodes.productivity.jira_node.JiraNode",
    "asana_node": "app.nodes.productivity.asana_node.AsanaNode",
    "google_sheets_node": "app.nodes.productivity.google_sheets_node.GoogleSheetsNode",
    "google_sheets_action": "app.nodes.productivity.google_sheets_node.GoogleSheetsNode",
    "google_docs_node": "app.nodes.productivity.google_docs_node.GoogleDocsNode",
    "trello_node": "app.nodes.productivity.trello_node.TrelloNode",
    "trello_action": "app.nodes.productivity.trello_node.TrelloNode",
    "todoist_node": "app.nodes.productivity.agile_tasks_batch.TodoistNode",
    "miro_node": "app.nodes.productivity.miro_node.MiroNode",
    "coda_node": "app.nodes.productivity.coda_node.CodaNode",
